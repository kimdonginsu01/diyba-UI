...
export default function MobileMenu({ onMenuClick }) {
  return (
    <div className={cx("mobile-modal")} onClick={onMenuClick}>
      <section className={cx("wrapper")} onClick={(e) => e.stopPropagation()}>
        <Link to="/">
